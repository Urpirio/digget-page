  ...
  return (
    <header className="w-full py-10 fixed  justify-center flex  ">
      <motion.section
        ...
        className="flex -translate-y-30 w-[85%] rounded-2xl  items-center b bg-white/80  backdrop-blur-2xl border border-gray-300/40  py-4 px-5  "
      >
        <div className="flex items-center w-1/4  flex-grow">
          <Image className="h-10 w-10" src={LogoPage} alt="" />
        </div>
        <nav className="flex  gap-5 w-1/2 text-sm justify-center">
          <Link
            href={""}
        ...
        <div className="flex items-center w-1/4 flex-grow justify-end gap-4">
